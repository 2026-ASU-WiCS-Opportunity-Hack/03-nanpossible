...
function getErrorMessage(error?: string) {
  switch (error) {
    ...
    case "email-required":
      return "A contact email is required so affiliate leads can reach you.";
    case "chapter-required":
      return "Select the WIAL affiliate you want to be associated with.";
    case "bio-too-short":
...
export default async function RegisterCoachPage({
        ...
        <section className="site-panel rounded-[2rem] p-6 md:p-8">
          ...
          <h2 className="mt-4 font-display text-3xl leading-none tracking-[-0.04em] text-teal-deep">
            {existingCoach.approved
              ...
              : "Awaiting affiliate admin approval."}
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-7 text-foreground/72">
            {existingCoach.approved
              ...
              : "You'll see this page flip to \u201CApproved\u201D once an affiliate admin reviews your submission. Keep editing your profile details from your account profile in the meantime."}
          </p>
  ...
  return (
    <AccountPageShell
      ...
      description="Submit a full coach profile. Affiliate admins approve each new submission before it appears in the public /coaches directory."
...
<label className="field-shell">
  ...
  />
        ...
        <section className="site-panel rounded-[2rem] p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <label className="field-shell">
              <span className="field-label">WIAL affiliate</span>
              <select
                className="field-input"
        ...
        <div className="site-panel flex flex-col gap-4 rounded-[2rem] p-6 md:flex-row md:items-center md:justify-between md:p-8">
          <p className="max-w-xl text-sm leading-6 text-foreground/70">
            Submissions are reviewed by an affiliate admin before they appear in
