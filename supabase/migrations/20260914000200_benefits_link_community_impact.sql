-- ============================================================
-- Migration: Upsert the "Action Learning Benefits" page (slug: benefits)
-- Source: https://wial.org/action-learning/benefits/
...
--   Rewritten from the live wial.org Action Learning Benefits page
--   (breakthrough problem solving, learning organization, high-
--   performing teams, leadership development, community impact,
--   challenging the status quo). External wial.org CTAs replaced
--   with internal /certification, /coaches, and /contact routes. The
--   Community impact section links to /community-impact (#144),
--   which took over the source's infographic and video utility
--   pages.
-- ============================================================
...
values (
    ...
    jsonb_build_object(
        ...
        'sections', jsonb_build_array(
            ...
            jsonb_build_object(
                'type', 'cta',
                'title', 'See how Action Learning changes communities',
                'body', 'Compare the traditional approach with WIAL Action Learning, watch the community impact video, and meet the organizations WIAL Gives Back has supported.',
                'href', '/community-impact',
                'label', 'Explore community impact'
            ),
            jsonb_build_object(
                'type', 'prose',
    ...
    jsonb_build_object(
        ...
        'sourceNotes', 'Rewritten from the live wial.org Action Learning Benefits page (breakthrough problem solving, learning organization, high-performing teams, leadership development, community impact, challenging the status quo). External wial.org CTAs replaced with internal /certification, /coaches, and /contact routes. The Community impact section links to /community-impact (#144), which took over the source''s infographic and video utility pages.'
    ),
    now(),
    now()
)
